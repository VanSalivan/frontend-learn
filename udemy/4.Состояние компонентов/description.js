...
//* - Централизовать (в одном месте) управление данными - хорошая практика
...
//? 44. Работа с формами
//* - Используем onChange в <input> чтобы получать текущее значение e.targe.value
//* - На форму вещаем onSubmit чтобы правильно обработать отправку формы - клик на кнопку отправки/Enter на клавиатуре 
//* - e.preventDefault - чтобы страница не перезагружалась

//? 45. Контролируемые компоненты
//* - Для того чтобы сделать элемент контролируемым - <input value={this.state.label}>
//*   Необходимо значение элемента устанавливалось из состояние компонента 

//* - Контролируемые компоненты value у input позволяют делать форматирование для № телефона или запрещать ввод строк/чисел
